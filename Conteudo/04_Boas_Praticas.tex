...
DevOps é um movimento cultural que visa a integração e otimização do processo de aprendizagem e cooperação entre os integrantes da equipe. Não é um cargo, mas sim uma visão de organização de trabalho que tem o objetivo de criar um \emph{pipeline} de implantação que seja veloz, seguro e integrado. Para tanto, precisa-se, é claro, de ferramentas que irão facilitar as integrações e monitoramento, mas DevOps trata-se mais de um movimento cultural do que uma aparelhagem técnica. Práticas de DevOps, como integração e entrega contínua são essenciais para o sucesso de uma aplicação com arquitetura de microsserviços.

...
% Only share required data - Your API should only return the appropriate data. Double-check what your endpoints return and make sure no security info, like an API Key, is returned. You can also remove "X-Powered-By" response headers, as they leak server-side information that could potentially aid attackers in exploitation. \cite{rapidAPI-security}

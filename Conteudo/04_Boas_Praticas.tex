...
I. Base de Código - Cada microsserviço deve ter uma base de código com rastreamento utilizando controle de revisão, e com muitos deploys
...
IV. Serviços de Apoio - Os microsserviços não deve fazer distinção entre serviços de terceiros e serviços locais.

V. Construir, lançar, e executar - Separe estritamente os builds e execute em estágios
...
XII. Processos de Admin - Executar tarefas de administração/gerenciamento como processos pontuais \cite{12factor, oracle_microservices}

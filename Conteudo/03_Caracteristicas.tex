...
Como explicado na sessão \autoref{sessao-monolitos}, quanto maior e mais antigo o software, mais difícil é de lhe dar manutenção. Porém, com componentes modularizados e organizados adequadamente, é possível que uma aplicação com arquitetura de microsserviços nunca se extingua, isso é, chegue em um ponto que fica inviável dar manutenção. 

Embora seja possível decompor uma aplicação monolítica em uma arquitetura de microsserviços - que é um tema de pesquisa muito recorrente na área da arquitetura de aplicações - esse assunto não faz parte do escopo deste trabalho.

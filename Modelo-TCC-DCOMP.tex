...
\titulo{Padrões e soluções de desenvolvimento de aplicações com arquitetura de microserviços}
...
\include{Conteudo/03_Padroes}
\include{Conteudo/04_Solucoes}
\include{Conteudo/03_Desenvolvimento}

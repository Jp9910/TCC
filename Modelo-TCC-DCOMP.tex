...
\titulo{Características, boas práticas e soluções no desenvolvimento de aplicações com arquitetura de microserviços}
...
\include{Conteudo/05_Solucoes}
\include{Conteudo/06_Conclusao}
\include{Conteudo/07_Plano_Continuidade.tex}
